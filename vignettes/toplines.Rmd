...
Refer to the [`kableExtra` package](https://cran.r-project.org/web/packages/kableExtra/index.html) for lots of examples on how to format the appearance of these tables in either HTML or PDF latex formats. I recommend the vignettes "Create Awesome HTML Table with knitr::kable and kableExtra" and "Create Awesome PDF Table with knitr::kable and kableExtra.
